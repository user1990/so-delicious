...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 54.687156;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 25.279651;
...
function typeAhead(search) {
  ...
  searchInput.on('keyup', function (e) {
    // Include pressing up, down or enter, other keys ignore!
